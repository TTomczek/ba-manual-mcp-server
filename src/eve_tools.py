...
@mcp.tool()
async def get_universe_categories_category_id(category_id: Annotated[int, Field(description="An Eve item category ID")], x_compatibility_date: Annotated[CompatibilityDate, Field(description="The compatibility date for the request.", )], accept_language: Annotated[AcceptLanguage, Field(description="The language to use for the response.")] = AcceptLanguage.EN, if_none_match: Annotated[str, Field(description="The ETag of the previous request. A 304 will be returned if this matches the current ETag.")] = "", x_tenant: Annotated[str, Field(description="The tenant ID for the request.")] = "tranquility"):
